...
# 🚧🚧🚧 <span style="background-color:red;padding: 2px 10px;border-radius: 5px">Projects</span> 🚧🚧🚧 

## <div style="background-color: black; padding: 5px 10px; border-radius: 5px; font-family: monospace">🐦 Twimba 🐦 </div> 
<br/>  

**Url**: https://jorgemf2604.github.io/scrimba/twimba/  
**Readme**: https://github.com/jorgemf2604/scrimba/blob/main/twimba/README.md    
<br/>  
<img src="./twimba/twimba.gif" width="100%"/>  
___  
<br/>

## <div style="background-color: black; padding: 5px 10px; border-radius: 5px; font-family: monospace">🍔 Restaurant App 🍔 </div> 
<br/>  
